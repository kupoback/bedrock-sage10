...
- [Installation](#Installation-of-New-Project)
...
- [Migrating to a Forge Server](#Migrating-to-a-Forge-Server)
    - [Database User Setup](#Database-User-Setup)
    - [Setting up the Repository](#Setting-up-the-Repository)
    - [Adjustment to the conf file](#Adjustment-to-the-conf-file)
    - [Setting up SSL](#Setting-up-SSL)
    - [Importing the database](#Importing-the-database)
    - [Importing the Uploads folder](#Importing-the-Uploads-folder)
    - [Installing ACF-JSON WP-CLI plugin](#Installing-ACF-JSON-WP-CLI-plugin)
    - [Adjusting the Deployment Settings](#Adjusting-the-Deployment-Settings)
- [Migrating to non-Forge Server](#Migrating-to-non-Forge-Server)
- [Plugins](#Plugins)
    - [Default Plugins](#Default-Plugins)
    - [Installing Plugins](#Installing-Plugins)
        - [WordPress Repository Plugin](#WordPress-Repository-Plugin)
        - [Premium Plugins](#Premium-Plugins)
            - [Making a plugin available via SatisPress](#Making-a-plugin-available-via-SatisPress)
- [Multi-Site Support](#Multi-Site-Support)
- [Migrating to a WPEngine Repo](#Migrating-to-a-WPEngine-Repo)
