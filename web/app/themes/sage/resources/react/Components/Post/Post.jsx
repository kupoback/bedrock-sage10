		...
		<article className={[
			...
			<div className="rotate-180 p-2 [writing-mode:_vertical-lr]">
				<time dateTime={dateString}
					...
					<span className="w-px flex-1 bg-gray-900/10 dark:bg-white/10 text-white"/>
			...
			<div className="flex flex-1 flex-col justify-between">
				<div className="border-l border-gray-900/10 p-4 dark:border-white/10 sm:!border-l-transparent sm:p-6">
                    ...
                    <h3 className="font-bold uppercase">
                        <a className="text-gray-900 dark:text-white hover:text-gray-200 dark:hover:text-gray-200"
                           href={permalink}>{title}</a>
                    </h3>

					{author && <p className="author text-white">By: {author}</p>}
					{categories && (
						<p className="categories text-white">
